...
class ApiLogPolicy
{
    ...
    {
        return $user->can('view_any_api::log');
    }
    ...
    {
        return $user->can('create_api::log');
    }
    ...
    {
        return $user->can('update_api::log');
    }
    ...
    {
        return $user->can('delete_api::log');
    }
    ...
    {
        return $user->can('delete_any_api::log');
    }
